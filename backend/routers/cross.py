"""cross router — 属灵星球扩充第三辑 (/api/cross)。引擎: cross_engine。"""
...
try:
    from backend import cross_engine as engine
except Exception:  # pragma: no cover
    import cross_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "cross_entries"


def init_cross_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
