"""envy router — 属灵星球扩充第四辑 (/api/envy)。引擎: envy_engine。"""
...
try:
    from backend import envy_engine as engine
except Exception:  # pragma: no cover
    import envy_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/envy", tags=["envy"])
_state: Dict[str, Any] = {}
_TABLE = "envy_entries"


def init_envy_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
