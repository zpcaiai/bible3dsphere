"""incarnation router — 属灵星球扩充第二辑 (/api/incarnation)。引擎: incarnation_engine。"""
...
try:
    from backend import incarnation_engine as engine
except Exception:  # pragma: no cover
    import incarnation_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/incarnation", tags=["incarnation"])
_state: Dict[str, Any] = {}
_TABLE = "incarnation_entries"


def init_incarnation_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
