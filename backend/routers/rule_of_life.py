"""rule-of-life router — 属灵星球扩充第二辑 (/api/rule-of-life)。引擎: rule_of_life_engine。"""
...
try:
    from backend import rule_of_life_engine as engine
...
router = APIRouter(prefix="/api/rule-of-life", tags=["rule-of-life"])
_state: Dict[str, Any] = {}
_TABLE = "rule_of_life_entries"


def init_rule_of_life_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
