"""neighbor-love router — 属灵星球扩充第二辑 (/api/neighbor-love)。引擎: neighbor_love_engine。"""
...
try:
    from backend import neighbor_love_engine as engine
except Exception:  # pragma: no cover
    import neighbor_love_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/neighbor-love", tags=["neighbor-love"])
_state: Dict[str, Any] = {}
_TABLE = "neighbor_love_entries"


def init_neighbor_love_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
