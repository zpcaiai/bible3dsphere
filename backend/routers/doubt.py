"""doubt router — 属灵星球扩充第三辑 (/api/doubt)。引擎: doubt_engine。"""
...
try:
    from backend import doubt_engine as engine
except Exception:  # pragma: no cover
    import doubt_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "doubt_entries"


def init_doubt_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
