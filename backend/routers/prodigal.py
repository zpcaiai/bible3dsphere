"""prodigal router — 属灵星球扩充第四辑 (/api/prodigal)。引擎: prodigal_engine。"""
...
try:
    from backend import prodigal_engine as engine
except Exception:  # pragma: no cover
    import prodigal_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/prodigal", tags=["prodigal"])
_state: Dict[str, Any] = {}
_TABLE = "prodigal_entries"


def init_prodigal_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
