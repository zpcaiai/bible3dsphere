"""providence router — 属灵星球扩充第三辑 (/api/providence)。引擎: providence_engine。"""
...
try:
    from backend import providence_engine as engine
except Exception:  # pragma: no cover
    import providence_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/providence", tags=["providence"])
_state: Dict[str, Any] = {}
_TABLE = "providence_entries"


def init_providence_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
