"""anger router — 属灵星球扩充第四辑 (/api/anger)。引擎: anger_engine。"""
...
try:
    from backend import anger_engine as engine
except Exception:  # pragma: no cover
    import anger_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/anger", tags=["anger"])
_state: Dict[str, Any] = {}
_TABLE = "anger_entries"


def init_anger_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
