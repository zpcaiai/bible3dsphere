"""fear-of-god router — 属灵星球扩充第二辑 (/api/fear-of-god)。引擎: fear_of_god_engine。"""
...
try:
    from backend import fear_of_god_engine as engine
except Exception:  # pragma: no cover
    import fear_of_god_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/fear-of-god", tags=["fear-of-god"])
_state: Dict[str, Any] = {}
_TABLE = "fear_of_god_entries"


def init_fear_of_god_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
