"""burnout router — 属灵星球扩充第四辑 (/api/burnout)。引擎: burnout_engine。"""
...
try:
    from backend import burnout_engine as engine
except Exception:  # pragma: no cover
    import burnout_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "burnout_entries"


def init_burnout_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
