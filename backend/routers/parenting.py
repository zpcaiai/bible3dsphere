"""parenting router — 属灵星球扩充第四辑 (/api/parenting)。引擎: parenting_engine。"""
...
try:
    from backend import parenting_engine as engine
except Exception:  # pragma: no cover
    import parenting_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/parenting", tags=["parenting"])
_state: Dict[str, Any] = {}
_TABLE = "parenting_entries"


def init_parenting_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
