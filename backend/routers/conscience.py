"""conscience router — 属灵星球扩充第四辑 (/api/conscience)。引擎: conscience_engine。"""
...
try:
    from backend import conscience_engine as engine
except Exception:  # pragma: no cover
    import conscience_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/conscience", tags=["conscience"])
_state: Dict[str, Any] = {}
_TABLE = "conscience_entries"


def init_conscience_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
