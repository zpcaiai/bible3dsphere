"""comfort router — 属灵星球扩充第四辑 (/api/comfort)。引擎: comfort_engine。"""
...
try:
    from backend import comfort_engine as engine
except Exception:  # pragma: no cover
    import comfort_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "comfort_entries"


def init_comfort_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
