"""adoption router — 属灵星球扩充第三辑 (/api/adoption)。引擎: adoption_engine。"""
...
try:
    from backend import adoption_engine as engine
except Exception:  # pragma: no cover
    import adoption_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "adoption_entries"


def init_adoption_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
