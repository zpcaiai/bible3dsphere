"""chronic-suffering router — 属灵星球扩充第四辑 (/api/chronic-suffering)。引擎: chronic_suffering_engine。"""
...
try:
    from backend import chronic_suffering_engine as engine
except Exception:  # pragma: no cover
    import chronic_suffering_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/chronic-suffering", tags=["chronic-suffering"])
_state: Dict[str, Any] = {}
_TABLE = "chronic_suffering_entries"


def init_chronic_suffering_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
