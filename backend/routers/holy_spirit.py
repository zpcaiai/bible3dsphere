"""holy-spirit router — 属灵星球扩充第三辑 (/api/holy-spirit)。引擎: holy_spirit_engine。"""
...
try:
    from backend import holy_spirit_engine as engine
except Exception:  # pragma: no cover
    import holy_spirit_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/holy-spirit", tags=["holy-spirit"])
_state: Dict[str, Any] = {}
_TABLE = "holy_spirit_entries"


def init_holy_spirit_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
