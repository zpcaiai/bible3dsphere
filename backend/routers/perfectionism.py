"""perfectionism router — 属灵星球扩充第四辑 (/api/perfectionism)。引擎: perfectionism_engine。"""
...
try:
    from backend import perfectionism_engine as engine
except Exception:  # pragma: no cover
    import perfectionism_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/perfectionism", tags=["perfectionism"])
_state: Dict[str, Any] = {}
_TABLE = "perfectionism_entries"


def init_perfectionism_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
