"""forgiveness router — 属灵星球扩充第二辑 (/api/forgiveness)。引擎: forgiveness_engine。"""
...
try:
    from backend import forgiveness_engine as engine
except Exception:  # pragma: no cover
    import forgiveness_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/forgiveness", tags=["forgiveness"])
_state: Dict[str, Any] = {}
_TABLE = "forgiveness_entries"


def init_forgiveness_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
