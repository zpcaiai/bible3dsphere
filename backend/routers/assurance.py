"""assurance router — 属灵星球扩充第二辑 (/api/assurance)。引擎: assurance_engine。"""
...
try:
    from backend import assurance_engine as engine
except Exception:  # pragma: no cover
    import assurance_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "assurance_entries"


def init_assurance_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
