"""prayer-school router — 属灵星球扩充第二辑 (/api/prayer-school)。引擎: prayer_classics_engine。"""
...
try:
    from backend import prayer_classics_engine as engine
except Exception:  # pragma: no cover
    import prayer_classics_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/prayer-school", tags=["prayer-school"])
_state: Dict[str, Any] = {}
_TABLE = "prayer_school_entries"


def init_prayer_school_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
