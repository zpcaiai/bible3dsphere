"""aging router — 属灵星球扩充第四辑 (/api/aging)。引擎: aging_engine。"""
...
try:
    from backend import aging_engine as engine
except Exception:  # pragma: no cover
    import aging_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "aging_entries"


def init_aging_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
