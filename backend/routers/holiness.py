"""holiness router — 属灵星球扩充第二辑 (/api/holiness)。引擎: holiness_engine。"""
...
try:
    from backend import holiness_engine as engine
except Exception:  # pragma: no cover
    import holiness_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/holiness", tags=["holiness"])
_state: Dict[str, Any] = {}
_TABLE = "holiness_entries"


def init_holiness_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
