"""fellowship router — 属灵星球扩充第二辑 (/api/fellowship)。引擎: fellowship_engine。"""
...
try:
    from backend import fellowship_engine as engine
except Exception:  # pragma: no cover
    import fellowship_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/fellowship", tags=["fellowship"])
_state: Dict[str, Any] = {}
_TABLE = "fellowship_entries"


def init_fellowship_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
