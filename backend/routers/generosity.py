"""generosity router — 属灵星球扩充第三辑 (/api/generosity)。引擎: generosity_engine。"""
...
try:
    from backend import generosity_engine as engine
except Exception:  # pragma: no cover
    import generosity_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/generosity", tags=["generosity"])
_state: Dict[str, Any] = {}
_TABLE = "generosity_entries"


def init_generosity_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
