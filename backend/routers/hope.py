"""hope router — 属灵星球扩充第二辑 (/api/hope)。引擎: hope_engine。"""
...
try:
    from backend import hope_engine as engine
except Exception:  # pragma: no cover
    import hope_engine as engine  # type: ignore
try:
...
def init_hope_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
