"""word-delight router — 属灵星球扩充第三辑 (/api/word-delight)。引擎: word_delight_engine。"""
...
try:
    from backend import word_delight_engine as engine
except Exception:  # pragma: no cover
    import word_delight_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/word-delight", tags=["word-delight"])
_state: Dict[str, Any] = {}
_TABLE = "word_delight_entries"


def init_word_delight_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
