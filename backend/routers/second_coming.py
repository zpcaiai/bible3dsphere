"""second-coming router — 属灵星球扩充第四辑 (/api/second-coming)。引擎: second_coming_engine。"""
...
try:
    from backend import second_coming_engine as engine
except Exception:  # pragma: no cover
    import second_coming_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/second-coming", tags=["second-coming"])
_state: Dict[str, Any] = {}
_TABLE = "second_coming_entries"


def init_second_coming_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
