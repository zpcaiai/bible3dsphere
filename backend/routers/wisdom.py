"""wisdom router — 属灵星球扩充第二辑 (/api/wisdom)。引擎: wisdom_engine。"""
...
try:
    from backend import wisdom_engine as engine
except Exception:  # pragma: no cover
    import wisdom_engine as engine  # type: ignore
try:
...
_state: Dict[str, Any] = {}
_TABLE = "wisdom_entries"


def init_wisdom_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
