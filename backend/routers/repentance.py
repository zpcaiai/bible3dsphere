"""repentance router — 属灵星球扩充第三辑 (/api/repentance)。引擎: repentance_engine。"""
...
try:
    from backend import repentance_engine as engine
except Exception:  # pragma: no cover
    import repentance_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/repentance", tags=["repentance"])
_state: Dict[str, Any] = {}
_TABLE = "repentance_entries"


def init_repentance_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
