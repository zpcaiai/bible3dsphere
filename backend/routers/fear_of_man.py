"""fear-of-man router — 属灵星球扩充第三辑 (/api/fear-of-man)。引擎: fear_of_man_engine。"""
...
try:
    from backend import fear_of_man_engine as engine
except Exception:  # pragma: no cover
    import fear_of_man_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/fear-of-man", tags=["fear-of-man"])
_state: Dict[str, Any] = {}
_TABLE = "fear_of_man_entries"


def init_fear_of_man_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
