"""acedia router — 属灵星球扩充第四辑 (/api/acedia)。引擎: acedia_engine。"""
...
try:
    from backend import acedia_engine as engine
except Exception:  # pragma: no cover
    import acedia_engine as engine  # type: ignore
try:
...
router = APIRouter(prefix="/api/acedia", tags=["acedia"])
_state: Dict[str, Any] = {}
_TABLE = "acedia_entries"


def init_acedia_router(*, get_db, release_db, get_session_user, to_shanghai_iso) -> None:
